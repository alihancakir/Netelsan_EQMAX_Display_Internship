# 1 "../../M031BSP/Library/StdDriver/src/timer.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 393 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../M031BSP/Library/StdDriver/src/timer.c" 2
# 12 "../../M031BSP/Library/StdDriver/src/timer.c"
...
# 13 "../../M031BSP/Library/StdDriver/src/timer.c" 2
# 44 "../../M031BSP/Library/StdDriver/src/timer.c"
uint32_t TIMER_Open(TIMER_T *timer, uint32_t u32Mode, uint32_t u32Freq)
{
...
# 77 "../../M031BSP/Library/StdDriver/src/timer.c"
void TIMER_Close(TIMER_T *timer)
{
    timer->CTL = 0;
    timer->EXTCTL = 0;
}
# 97 "../../M031BSP/Library/StdDriver/src/timer.c"
int32_t TIMER_Delay(TIMER_T *timer, uint32_t u32Usec)
{
    uint32_t u32Clk = TIMER_GetModuleClock(timer);
...
# 190 "../../M031BSP/Library/StdDriver/src/timer.c"
void TIMER_EnableCapture(TIMER_T *timer, uint32_t u32CapMode, uint32_t u32Edge)
{
    timer->EXTCTL = (timer->EXTCTL & ~((0x1ul << (4)) | (0x3ul << (1)))) |
                    u32CapMode | u32Edge | (0x1ul << (3));
}
# 205 "../../M031BSP/Library/StdDriver/src/timer.c"
void TIMER_DisableCapture(TIMER_T *timer)
{
    timer->EXTCTL &= ~(0x1ul << (3));
}
# 224 "../../M031BSP/Library/StdDriver/src/timer.c"
void TIMER_EnableEventCounter(TIMER_T *timer, uint32_t u32Edge)
{
    timer->EXTCTL = (timer->EXTCTL & ~(0x1ul << (0))) | u32Edge;
    timer->CTL |= (0x1ul << (24));
}
# 239 "../../M031BSP/Library/StdDriver/src/timer.c"
void TIMER_DisableEventCounter(TIMER_T *timer)
{
    timer->CTL &= ~(0x1ul << (24));
}
# 254 "../../M031BSP/Library/StdDriver/src/timer.c"
uint32_t TIMER_GetModuleClock(TIMER_T *timer)
{
    uint32_t u32Src;
...
# 295 "../../M031BSP/Library/StdDriver/src/timer.c"
...
# 315 "../../M031BSP/Library/StdDriver/src/timer.c"
void TIMER_DisableFreqCounter(TIMER_T *timer)
{
    timer->CTL &= ~(0x1ul << (10));
}
# 330 "../../M031BSP/Library/StdDriver/src/timer.c"
void TIMER_SetTriggerSource(TIMER_T *timer, uint32_t u32Src)
{
    timer->CTL = (timer->CTL & ~(0x1ul << (18))) | u32Src;
}
# 347 "../../M031BSP/Library/StdDriver/src/timer.c"
void TIMER_SetTriggerTarget(TIMER_T *timer, uint32_t u32Mask)
{
    timer->CTL = (timer->CTL & ~((0x1ul << (19)) | (0x1ul << (21)) | (0x1ul << (8)) | (0x1ul << (9)))) | (u32Mask);
}
# 367 "../../M031BSP/Library/StdDriver/src/timer.c"
void TIMER_CaptureSelect(TIMER_T *timer, uint32_t u32Src)
{
    if (u32Src == (0xFFUL))
    {
...
# 394 "../../M031BSP/Library/StdDriver/src/timer.c"
int32_t TIMER_ResetCounter(TIMER_T *timer)
{
    uint32_t u32Delay;
